...
struct Dr_PawApp: App {
    ...
    init() {
        ...
        // One-time cleanup: wipes out the stray random-UUID notifications that
        // stacked up from the old test call below. Safe to remove this line
        // after running the app once on your device.
